...
public class PlayerController : MonoBehaviour
{
    ...
    private void HandleMovement()
    {
        if (IsGrounded())
        {
            ...
            if (Input.GetButtonDown("Jump"))
            {
                ...
                _animator.SetTrigger("jump"); // ������� � ��������� Jumping Up
    ...
    private void HandleAttacks()
    {
        if (canAttack)
        {
            ...
            {
                Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition); if (Physics.Raycast(ray, out RaycastHit hit, 5f)) { if (hit.collider.GetComponent<ItemPickup>() != null) { return; } } _animator.SetTrigger("attack"); // ������� � ��������� Standing Melee Kick
